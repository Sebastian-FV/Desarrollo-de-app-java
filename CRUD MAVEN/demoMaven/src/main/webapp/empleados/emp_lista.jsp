	...
	<div class="container">
		<div>
			<a class="btn btn-primary"
				href="EmpleadoServletController?action=add">Agregar_empleado</a> <a
			...
			<c:forEach var="empleado" items="${listEmp}">
				<tr>
					...
					<td><a class="btn btn-primary"
						href="EmpleadoServletController?action=edit&id=<c:out value="${empleado.id}"></c:out>">Editar<a />
							<a class="btn btn-primary"
							href="EmpleadoServletController?action=eliminar&id=<c:out value="${empleado.id}"></c:out>">Eliminar<a /></td>
				</tr>
			</c:forEach>
		</tbody>
	</div>
